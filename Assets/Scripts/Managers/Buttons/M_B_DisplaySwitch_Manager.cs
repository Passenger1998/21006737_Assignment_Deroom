...
public class M_B_DisplaySwitch_Manager : MonoBehaviour
{
    ...
    public List<IC_DS_DisplaySwitchButtons_Locals> IC_DS_ScreenSwitch_Locals_list;
    ...
    public List<IC_DS_DisplaySwitchButtons_Locals> IC_DS_ScreenSwitch_Locals_list_Return()
    {
    ...
    public List<DirectionPad_Status> DirectionPad_Return()
    {
        ...
        foreach (IC_DS_DisplaySwitchButtons_Locals locals in IC_DS_ScreenSwitch_Locals_list)
        {
