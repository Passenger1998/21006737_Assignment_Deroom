...
public class M_I_Movement_Manager : MonoBehaviour
{
    ...
    public void MovementControl_FullMouse()
    {
        ...
        List<DirectionPad_Status> DirectionPad_Status_list = scene_Manager.managerList.userInterface.directionPad_Manager.DirectionPad_Return();
            ...
            foreach (DirectionPad_Status directionPad_Status in DirectionPad_Status_list)
            {
                ...
                switch (directionPad_Status.direction)
                {
                    case Direction.front:
                        if (directionPad_Status.isHovered)
                        {
                            Debug.Log("working");
